...
type SurfaceTone = 'panel' | 'muted' | 'inset' | 'light' | 'control' | 'warning' | 'danger' | 'success' | 'none';
...
const surfaceToneClass: Record<SurfaceTone, string> = {
  ...
  light: 'rounded-xl border border-sky-300 bg-sky-100 text-slate-950 shadow-md shadow-slate-950/20',
  control: 'rounded-2xl border border-cyan-800/20 bg-[#d5e6ee] text-slate-950 shadow-lg shadow-cyan-950/15 backdrop-blur-xl',
